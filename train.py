# transformer https://www.youtube.com/watch?v=vsqKGZT8Qn8 
# self-attention https://www.youtube.com/watch?v=eMlx5fFNoYc&t=269s
# coding=utf-8
...
def setup(args):
    ...
    model = VisionTransformer(config, args.img_size,
                              zero_head=True, num_classes=num_classes, vis=True)
